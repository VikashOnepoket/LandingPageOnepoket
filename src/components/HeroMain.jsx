        ...
        <>
            <div className='w-5/6 mx-auto flex items-center justify-between hero-container mt-12'>
                <div className={`flex flex-col w-1/2 gap-10 text-container-hero ${animateText ? 'animate-slide-in-left text-center sm:text-start' : ''}`}>
                    <h1 className='text-[#0052CC] 2xl:text-[3rem] 2xl:leading-[4rem] xl:text-[2rem] xl:leading-[2rem] font-bold inter text-[2.5rem] leading-[3.5rem]'>
                    ...
                    <div>
                        ...
                        <p className='text-[18px] leading-[35px] font-normal mt-4 para-container-text'>
                            Want to see it in action?
                        </p>
                    </div>
                    <div className='text-center sm:text-start w-full'>
                        <button
                            className='hover:bg-[#1971D8] hover:text-white bg-[#0052CC] rounded-lg text-[18px] leading-[23px] font-bold text-white px-[16px] py-[14px] gap-3 sm:w-[221px] w-full mt-5 cursor-pointer button-id border border-[#0052CC] hover:border hover:border-[#1971D8]'
