...
const HeroMain = () => {
  return (
    <div className='mt-[9rem] mb-[6rem] text-center'>
      ...
      <div className='flex justify-center items-center mt-[3.81rem]'>
        <button className='flex items-center justify-center  py-[1rem] px-[2.3125rem] rounded-[0.625rem]  bg-[#0052CC] text-white button-shadow text-[1rem] font-bold leading-[2rem]'>BOOK YOUR DEMO
          <span className='ml-5'>
