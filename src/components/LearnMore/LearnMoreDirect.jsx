                ...
                <div className='' >
                    ...
                    <div className='md:w-[80%] xl-w-[90%] mx-auto mt-[5rem] w-[90%]'>
                        ...
                        <div className='flex items-center justify-between gap-[9.5rem] md:flex-row flex-col-reverse'>
                            <div className='rounded-[20px] text-center p-10 border-[#D8D8D8]   border bg-gradient-to-r from-[#396fb0] to-[#0D4F93]  md:h-[13.3125rem] h-auto my-8 md:w-1/2 w-full'>
