        ...
        <>
            ...
            <div className='mt-20'>
                ...
                <div className='text-center'>
                    ...
                    <p className='text-[#202123BF] text-[20px] leading-[26px] mt-4 w-1/2 mx-auto font-semibold'>Harness the power of first-party data to gain invaluable insights into your audience, without relying on third-party intermediaries. By collecting data directly from your users, you can:</p>
                </div>

                {/* card section */}
                <div className='md:w-[80%] xl-w-[90%] mx-auto mt-20'>
                    {/* card 1 */}
                    <div className='flex items-center justify-between gap-10 '>
                        <div className='rounded-[20px] text-center p-10 border-[#D8D8D8]   border bg-gradient-to-r from-[#396fb0] to-[#0D4F93]  h-[180px] w-1/2'>
                    ...
                    {/* card 3 */}
                    <div className='flex items-center justify-between gap-10 mt-20'>
                        <div className='rounded-[20px] text-center p-10 border-[#D8D8D8] border   bg-gradient-to-r from-[#396fb0] to-[#0D4F93] h-[200px] w-1/2'>
