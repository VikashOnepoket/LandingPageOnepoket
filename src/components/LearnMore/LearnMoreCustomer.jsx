  ...
  return (
    ...
    <div className='mt-20'>
        ...
        <div className='text-center'>
            ...
            <p className='text-[#202123BF] text-[20px] leading-[26px] mt-4 w-1/2 mx-auto font-semibold'>Empower your customers with a smooth and seamless after-sales service experience, making it easier for them to manage everything in one place:</p>
        </div>
