...
import curve from '../../assets/curve.png';  // Import your curve PNG
...
import effect from '../../assets/blur effect 3rd fold.png'
...
const Direct = () => {
    ...
    return (
        <div
            className="w-[100%] py-16 relative" style={{ backgroundImage: `url(${'https://firebasestorage.googleapis.com/v0/b/onepoketstage.appspot.com/o/blur%20effect%203rd%20fold.png?alt=media&token=a944b11d-89ae-4e5f-82bf-499ccd8f5634'})`, backgroundSize: 'cover', backgroundPosition: 'center' }}
            ...
            <div className='w-[80%] mx-auto mt-32 relative z-10'>
                ...
                <div className='mt-24 flex justify-between gap-10 ' style={{ backgroundImage: `url(${curve})`, backgroundSize: 'contain', backgroundPosition: 'center' }}>
                    ...
                    <div className='w-[50%] relative'>
                        ...
                        <img src={image1} alt="Popup Image" className='absolute w-[140px] top-[-60px] right-[-80px]' />
                    </div>
                </div>
                ...
                <div className='mt-96 flex justify-between gap-10 ' >
                    ...
                    <div className="relative w-[50%] flex" style={{ backgroundImage: `url(${curve})`, backgroundSize: 'contain', backgroundPosition: 'center' }}>
                        ...
                        <img src={customer3} alt="Confirmation Icon" className="absolute top-[25px] left-[250px] w-[150px] " />
                    </div>
                    {/* Left Side */}
                ...
                <div className='mt-24 flex justify-between gap-10' style={{ backgroundImage: `url(${curve})`, backgroundSize: 'contain', backgroundPosition: 'center' }}>
                        ...
                        <motion.button
                            ...
                            whileHover={{
                                ...
                                transition: {
                                    ...
                                    mass: 1,          // Defines the mass of the object
                                    curve: "easeInOut", // Custom curve for the motion
                                }
                            }}
                            // Add animation while tap (click)
                            whileTap={{
                                scale: 0.95,
                                transition: {
                                    type: 'spring',
                    ...
                    <div className='w-[40%] relative mt-12'>
                        ...
                        <img src={image3} alt="Popup Image" className='absolute top-[160px] right-[-80px] w-[300px]' />
                    </div>
                </div>
